...
<body onload="' . ($format === 'print' || $format === 'pdf' ? 'window.print()' : '') . '">
    ...
    private function getModuleMap(): array
    {
        return [
            ...
            'intensi-misa' => ['model' => \App\Models\IntensiMisa::class, 'title' => 'Intensi Misa', 'columns' => [['key' => 'nama_pemohon', 'label' => 'Pemohon', 'isPrimary' => true], ['key' => 'intensi', 'label' => 'Intensi Doa'], ['key' => 'tgl_misa', 'label' => 'Tgl Misa']]],
            ...
            'keuangan' => ['model' => \App\Models\Keuangan::class, 'title' => 'Keuangan & Iuran', 'columns' => [['key' => 'kategori', 'label' => 'Kategori', 'isPrimary' => true], ['key' => 'jenis_transaksi', 'label' => 'Jenis'], ['key' => 'nominal', 'label' => 'Nominal (Rp)'], ['key' => 'tanggal', 'label' => 'Tanggal']]],
            'aset' => ['model' => \App\Models\Aset::class, 'title' => 'Aset & Inventaris', 'columns' => [['key' => 'nama_aset', 'label' => 'Nama Aset', 'isPrimary' => true], ['key' => 'kode_aset', 'label' => 'Kode'], ['key' => 'kondisi', 'label' => 'Kondisi']]],
