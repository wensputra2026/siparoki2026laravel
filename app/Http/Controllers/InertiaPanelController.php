...
class InertiaPanelController extends Controller
{
    ...
    private function getModuleMap(): array
    {
        return [
            ...
            'kronik-paroki' => ['model' => \App\Models\KronikParoki::class, 'title' => 'Kronik Paroki', 'columns' => [['key' => 'foto_utama', 'label' => 'Foto', 'isImage' => true], ['key' => 'judul_kronik', 'label' => 'Judul Kronik', 'isPrimary' => true], ['key' => 'tanggal_peristiwa', 'label' => 'Tanggal Peristiwa'], ['key' => 'kategori_kronik', 'label' => 'Kategori'], ['key' => 'lokasi_peristiwa', 'label' => 'Lokasi'], ['key' => 'penulis', 'label' => 'Penulis'], ['key' => 'status_publish', 'label' => 'Status']]],
            'kronik_paroki' => ['model' => \App\Models\KronikParoki::class, 'title' => 'Kronik Paroki', 'columns' => [['key' => 'foto_utama', 'label' => 'Foto', 'isImage' => true], ['key' => 'judul_kronik', 'label' => 'Judul Kronik', 'isPrimary' => true], ['key' => 'tanggal_peristiwa', 'label' => 'Tanggal Peristiwa'], ['key' => 'kategori_kronik', 'label' => 'Kategori'], ['key' => 'lokasi_peristiwa', 'label' => 'Lokasi'], ['key' => 'penulis', 'label' => 'Penulis'], ['key' => 'status_publish', 'label' => 'Status']]],
            'jadwal-petugas-liturgi' => ['model' => \App\Models\JadwalPetugasLiturgi::class, 'title' => 'Petugas Liturgi Misa', 'columns' => [
                ['key' => 'nama_petugas', 'label' => 'Nama Petugas', 'isPrimary' => true],
                ['key' => 'jenis_tugas', 'label' => 'Jenis Tugas (Lektor/Mazmur/dll)'],
                ['key' => 'kelompok', 'label' => 'Kelompok / KUB / Lingkungan'],
                ['key' => 'keterangan', 'label' => 'Keterangan'],
            ]],
            'jadwal_petugas_liturgi' => ['model' => \App\Models\JadwalPetugasLiturgi::class, 'title' => 'Petugas Liturgi Misa', 'columns' => [
                ['key' => 'nama_petugas', 'label' => 'Nama Petugas', 'isPrimary' => true],
                ['key' => 'jenis_tugas', 'label' => 'Jenis Tugas (Lektor/Mazmur/dll)'],
                ['key' => 'kelompok', 'label' => 'Kelompok / KUB / Lingkungan'],
                ['key' => 'keterangan', 'label' => 'Keterangan'],
            ]],
            'petugas-liturgi' => ['model' => \App\Models\JadwalPetugasLiturgi::class, 'title' => 'Petugas Liturgi Misa', 'columns' => [
                ['key' => 'nama_petugas', 'label' => 'Nama Petugas', 'isPrimary' => true],
                ['key' => 'jenis_tugas', 'label' => 'Jenis Tugas (Lektor/Mazmur/dll)'],
                ['key' => 'kelompok', 'label' => 'Kelompok / KUB / Lingkungan'],
                ['key' => 'keterangan', 'label' => 'Keterangan'],
            ...
            'umat-meninggal' => ['model' => \App\Models\Defunctorum::class, 'title' => 'Data Umat Meninggal (Defunctorum)', 'columns' => [
                ['key' => 'nama_lengkap', 'altKey' => 'nama_baptis', 'label' => 'Nama Almarhum / Almarhumah', 'isPrimary' => true],
                ['key' => 'jenis_kelamin', 'label' => 'L/P'],
                ['key' => 'tempat_lahir', 'label' => 'Tempat Lahir'],
                ['key' => 'tanggal_lahir', 'label' => 'Tgl Lahir', 'isDate' => true],
            ...
            'sambutan-pastor' => ['model' => \App\Models\SambutanPastor::class, 'title' => 'Sambutan Pastor Paroki', 'columns' => [
            ...
            'sambutan_pastor' => ['model' => \App\Models\SambutanPastor::class, 'title' => 'Sambutan Pastor Paroki', 'columns' => [
                ['key' => 'foto_pastor', 'altKey' => 'foto', 'label' => 'Foto Pastor', 'isImage' => true],
                ['key' => 'nama_pastor', 'label' => 'Nama Pastor', 'isPrimary' => true],
                ['key' => 'jabatan_pastor', 'altKey' => 'jabatan', 'label' => 'Jabatan'],
                ['key' => 'judul_sambutan', 'label' => 'Judul Sambutan'],
            ...
            'metode-pembayaran' => ['model' => \App\Models\MetodePembayaran::class, 'title' => 'Metode Pembayaran & QRIS', 'columns' => [
                ...
                ['key' => 'tipe', 'label' => 'Tipe (Bank/E-Wallet/QRIS)'],
                ['key' => 'status', 'label' => 'Status'],
            ]],
            'metode_pembayaran' => ['model' => \App\Models\MetodePembayaran::class, 'title' => 'Metode Pembayaran & QRIS', 'columns' => [
                ['key' => 'logo_bank', 'label' => 'Logo Bank', 'isImage' => true],
                ['key' => 'nama_bank', 'label' => 'Nama Bank / Channel', 'isPrimary' => true],
                ['key' => 'nomor_rekening', 'label' => 'No. Rekening / VA'],
                ['key' => 'atas_nama', 'label' => 'Atas Nama (Pemilik)'],
            ...
            'slider' => ['model' => \App\Models\SliderBanner::class, 'title' => 'Banner Slider Beranda', 'columns' => [
            ...
            'slider-banner' => ['model' => \App\Models\SliderBanner::class, 'title' => 'Banner Slider Beranda', 'columns' => [
                ['key' => 'gambar', 'label' => 'Gambar Banner', 'isImage' => true],
                ['key' => 'judul', 'label' => 'Judul Slider', 'isPrimary' => true],
                ['key' => 'subjudul', 'label' => 'Subjudul'],
                ['key' => 'link_url', 'label' => 'Link Tujuan'],
            ...
            'slider_banner' => ['model' => \App\Models\SliderBanner::class, 'title' => 'Banner Slider Beranda', 'columns' => [
                ['key' => 'gambar', 'label' => 'Gambar Banner', 'isImage' => true],
                ['key' => 'judul', 'label' => 'Judul Slider', 'isPrimary' => true],
                ['key' => 'subjudul', 'label' => 'Subjudul'],
                ['key' => 'link_url', 'label' => 'Link Tujuan'],
