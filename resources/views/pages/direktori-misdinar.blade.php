@extends('layouts.app')
@section('title', 'Direktori Putra-Putri Altar / Misdinar - Kristus Raja Katedral')
@section('content')
<div class="py-12 bg-slate-100 dark:bg-[#090e1a]">
    <div class="max-w-4xl mx-auto px-4">
        <div class="bg-white dark:bg-[#101d31] rounded-3xl p-8 border border-slate-200 dark:border-[#263a55] shadow-sm">
            ...
            <p class="text-slate-600 dark:text-slate-300">Daftar anggota dan pengurus paguyuban pelayan altar Kristus Raja.</p>
        </div>
    </div>
</div>
@endsection
